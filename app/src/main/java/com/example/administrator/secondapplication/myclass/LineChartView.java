...
public class LineChartView extends View implements View.OnTouchListener {
    ...
    private void init() {
        surface = new Surface();
        mDrawableDot = getResources().getDrawable(R.mipmap.eye);
        mDrawableTip = getResources().getDrawable(R.mipmap.bg_add_pic);
        if (mBitmapBg == null) {
            mBitmapBg = BitmapFactory.decodeResource(getResources(), R.mipmap.add);
        }
    ...
    private class Surface {
        ...
        public int titleColor = getResources().getColor(R.color.contentword);
        public int lineColor = getResources().getColor(R.color.colorAccent);
        public int textColor = Color.WHITE;
        public int pointColor = lineColor;
        public int axisXColor = getResources().getColor(R.color.blue);
        public int gridColor = getResources().getColor(R.color.black);
